<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 16px;">
            <el-breadcrumb-item :to="{ path: '/employees/quitdateList' }">
                <i class="el-icon-s-promotion"></i> 后台管理
            </el-breadcrumb-item>
            <el-breadcrumb-item>離職員工列表</el-breadcrumb-item>
        </el-breadcrumb>
        ...
        <el-table
            ...
            <el-table-column prop="quitdate" align="center" label="離職時間" width="105"></el-table-column>
    ...
    export default {
        ...
        data() {
            ...
            loadAlbumList() {
                ...
                let url = 'http://'+this.baseUrl+':8090/employees/listByQuitdate'
                console.log('url=' + url);
